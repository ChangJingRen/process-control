...
class Window:
    def __init__(self, tank):
        pygame.init()
        pygame.display.set_caption("12 Tank simulation")
        ...
        self.background_image = pygame.image.load(
            "Q_learning/Tank_8/visualize/images/8_tanks.png"
        ).convert()
        ...
        self.tank7 = TankImage(tank[6], 433, 553)
        self.tank8 = TankImage(tank[7], 783, 553)
        self.tank9 = TankImage(tank[8], 533, 353)
        self.tank10 = TankImage(tank[9], 683, 353)
        self.tank11 = TankImage(tank[10], 533, 553)
        self.tank12 = TankImage(tank[11], 683, 553)
    ...
    def Draw(self, input_z):
        ...
        self.tank10.draw(self.screen, input_z[9])
        self.tank11.draw(self.screen, input_z[10])
        self.tank12.draw(self.screen, input_z[11])
        pygame.display.flip()
        return True
