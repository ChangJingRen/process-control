...
def main():
        ...
        for e in range(episodes):
            ...
            if e % mean_episode == 0 and e != 0:
                ...
                print(
                    ...
                    ### r1: {mean_r[0]} r2: {mean_r[1]}, r3: {mean_r[2]} r4: {mean_r[3]}, r5: {mean_r[4]} r6: {mean_r[5]} r7: {mean_r[6]}, r8: {mean_r[7]} r9: {mean_r[8]}"
                )
                t_mean = []
    ...
    labels = ["Tank 1", "Tank 2", "Tank 3", "Tank 4", "Tank 5", "Tank 6", "Tank 7", "Tank 8", "Tank 9"]
