...
def tune_controllers(tank_number=0):
    ...
    print("max_reward: " + str(round(max_reward, 8)) + " with " + "tau_c: " + str(max_reward_tau_c))
...
plt.subplot(3, 1, 1)
plt.plot(
    all_tau_c_app[6], all_max_reward_values[6], color="peru", label="Tank 7"
)
plt.ylabel("SSE")
plt.xlabel(r"$\tau_c$")
# plt.ylim(top=0.05)
