...
class Window:
    def __init__(self, tank):
        ...
        self.background_image = pygame.image.load(
            "P_controller/Tank_6/visualize/images/6_tanks.png"
        ).convert()
        ...
        self.tank7 = TankImage(tank[6], 533, 353)
        self.tank8 = TankImage(tank[7], 683, 353)
        self.tank9 = TankImage(tank[8], 683, 353)
